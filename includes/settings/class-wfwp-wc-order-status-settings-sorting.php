<?php
/**
 * Order Status for WooCommerce - Sorting Section Settings
 *
 * @version 1.9.1
 * @since   1.9.1
 *
...
if ( ! class_exists( 'WFWP_WC_Order_Status_Settings_Sorting' ) ) :

	/**
	 * WFWP_WC_Order_Status_Settings_Sorting class.
	 *
	 * @version 1.9.1
	 * @since   1.9.1
	 */
	class WFWP_WC_Order_Status_Settings_Sorting extends WFWP_WC_Order_Status_Settings_Section {
		...
		public function __construct() {
			$this->id   = 'sorting';
			$this->desc = __( 'Sorting', 'order-status-for-woocommerce' );
			parent::__construct();
		}

		/**
		 * Get unsorted statuses.
		 *
		 * @version 1.9.0
		 * @since   1.9.0
		 */
		public function get_unsorted_statuses() {
			remove_filter(
				'wc_order_statuses',
...
return new WFWP_WC_Order_Status_Settings_Sorting();
